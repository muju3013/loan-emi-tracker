        ...
        <tbody>
          {emis.map((emi) => {
            ...
            return (
              <tr
                key={emi.id}
                className={`border-b border-slate-100 hover:bg-slate-50 ${rowClass}`}
              >
                ...
                <td className="px-4 py-3">
                  {emi.status !== "paid" ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2 py-1 rounded-md border border-slate-300 text-xs hover:bg-slate-100"
                    >
